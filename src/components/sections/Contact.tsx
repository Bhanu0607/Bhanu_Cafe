  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validate()) {
      try {
        ...
        const response = await fetch("https://formsubmit.co/ajax/chawlakaran663@gmail.com", {
          method: "POST",
          headers: { 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card rounded-xl p-4 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-400 font-medium mb-1">Address</p>
              <p className="text-gray-900 dark:text-white">Main Road, City Center, Your City - 000000</p>
            </div>
          </div>

          <a href="tel:+919999999999" className="glass-card rounded-xl p-4 flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
            <div className="bg-primary-100 dark:bg-primary-900/30 p-3 rounded-lg text-primary-600 dark:text-primary-400">
              <Phone className="w-6 h-6" />
            </div>
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-400 font-medium mb-1">Phone</p>
              <p className="text-gray-900 dark:text-white">+91 99999 99999</p>
            </div>
          </a>

          <a href="mailto:info@bhanucybercafe.com" className="glass-card rounded-xl p-4 flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
            <div className="bg-primary-100 dark:bg-primary-900/30 p-3 rounded-lg text-primary-600 dark:text-primary-400">
              <Mail className="w-6 h-6" />
            </div>
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-400 font-medium mb-1">Email</p>
              <p className="text-gray-900 dark:text-white">info@bhanucybercafe.com</p>
            </div>
          </a>

          <a href="https://wa.me/919999999999" target="_blank" rel="noreferrer" className="glass-card rounded-xl p-4 flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
            <div className="bg-green-100 dark:bg-green-900/30 p-3 rounded-lg text-green-600 dark:text-green-400">
              <MessageCircle className="w-6 h-6" />
            </div>
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-400 font-medium mb-1">WhatsApp</p>
          ...
          <div className="rounded-xl overflow-hidden w-full h-64 border border-gray-200 dark:border-gray-800">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3000!2d0!3d0"
              width="100%"
              height="100%"
              style={{ border: 0 }}
        ...
        <div className="glass-card rounded-2xl p-8 h-fit">
          <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Send us a message</h4>
          ...
          <AnimatePresence mode="wait">
            {isSubmitted ? (
              ...
              >
                ...
                <h5 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Message sent successfully!</h5>
                <p className="text-gray-800 dark:text-gray-400">We'll get back to you shortly.</p>
              </motion.div>
            ) : (
              <motion.form
                key="form"
