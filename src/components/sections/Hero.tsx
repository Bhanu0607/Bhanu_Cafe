...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-900 pt-20"
    >
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        >
          ...
          >
            <span className="animated-gradient-text">Bhanu Cyber Cafe</span>
          </motion.h1>
          <motion.h1
            variants={itemVariants}
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg md:text-xl text-gray-800 dark:text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed"
          >
            Government Services, Online Applications, Printing, Scanning, Ticket
            Booking, Passport Services, PAN Card and Much
            More.
          </motion.p>
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-wrap justify-center items-center gap-x-8 gap-y-4 text-sm font-medium text-slate-800 dark:text-slate-400"
          >
